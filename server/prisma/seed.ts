...
const firstUserOAuth = "1111-1111-111-111";
const firstUserCreationDate = new Date("2023-01-20T03:00:00.000");
...
async function run() {
  ...
  await Promise.all([
    prisma.user.create({
      data: {
        id: firstUserId,
        id_oauth: firstUserOAuth,
        username: "admin",
        email: "fernandopinheiro@email.com",
        password: "HASH",
